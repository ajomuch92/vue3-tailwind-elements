...
const props = defineProps({
  ...
  color: { ...oneOf(['normal', 'primary', 'success', 'warning', 'danger'] as const), default: 'normal' },
});
...
const closeButtonClass = computed(() => ({
  'text-black hover:text-black': !isTinted.value,
  'btn-close-white text-white hover:text-white': isTinted.value,
}));
</script>
